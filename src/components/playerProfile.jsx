  ...
  return (
    <>
      ...
      <div className="player-header">
        <img src="../teamIMGs/spurs.png" alt="San Antonio Spurs Logo" className="team-logo" />
        <div className="player-basic-info">
          <h1>Chris Paul</h1>
          <p>San Antonio Spurs | #3 | Guard</p>
        </div>
        <div className="player-ratings">
          <div className="rating-badge overall">Overall<br /><span>8.0</span></div>
          <div className="rating-badge">Shooting<br /><span>8.1</span></div>
          <div className="rating-badge">Dunking<br /><span>4.0</span></div>
          <div className="rating-badge">Defense<br /><span>7.0</span></div>
          <div className="rating-badge">Playmaking<br /><span>8.5</span></div>
          <div className="rating-badge">Rebounding<br /><span>4.4</span></div>
        </div>
      </div>
      ...
      <div className="user-rating-form">
        ...
        <form className="rating-form">
          ...
          <input type="number" name="shooting" step="0.1" min="1" max="10" placeholder="Shooting" value={ratings.shooting} onChange={handleChange} />
          <input type="number" name="dunking" step="0.1" min="1" max="10" placeholder="Dunking" value={ratings.dunking} onChange={handleChange} />
          <input type="number" name="defense" step="0.1" min="1" max="10" placeholder="Defense" value={ratings.defense} onChange={handleChange} />
          <input type="number" name="playmaking" step="0.1" min="1" max="10" placeholder="Playmaking" value={ratings.playmaking} onChange={handleChange} />
          <input type="number" name="rebounding" step="0.1" min="1" max="10" placeholder="Rebounding" value={ratings.rebounding} onChange={handleChange} />
      ...
      <main className="player-main">
        <div className="player-profile-top">
          <img src="../playerIMGs/CP3.avif" alt="Chris Paul" className="player-photo" />
